...
class PaymentMethodController extends Controller
{
    ...
    public function updatePaypal(Request $request){
     if(!auth()->user()->can('payment-method-paypal')){
            abort(403, 'Unauthorized action.');
        }    
        $rules = [
    ...
    public function updateStripe(Request $request){
     if(!auth()->user()->can('payment-method-stripe')){
            abort(403, 'Unauthorized action.');
        }      
        $rules = [
            'stripe_key' => 'required',
    ...
    public function updateRazorpay(Request $request){
        if(!auth()->user()->can('payment-method-Razorpay')){
            abort(403, 'Unauthorized action.');
        }  
        $rules = [
    ...
    public function updateBank(Request $request){
         if(!auth()->user()->can('payment-method-bank')){
            abort(403, 'Unauthorized action.');
        } 
        $rules = [
    ...
    public function updateMollie(Request $request){
        if(!auth()->user()->can('payment-method-updateMobile')){
            abort(403, 'Unauthorized action.');
        }  
        $rules = [
            'mollie_key' => 'required',
    ...
    public function updatePayStack(Request $request){
        if(!auth()->user()->can('payment-method-updatePayStack')){
            abort(403, 'Unauthorized action.');
        } 
        $rules = [
    ...
    public function updateflutterwave(Request $request){
         if(!auth()->user()->can('payment-method-updateflutterwave')){
            abort(403, 'Unauthorized action.');
        } 
        $rules = [
            'public_key' => 'required',
