...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    // Attribute start
    // variant name
    Route::get('create-variant-name', [AttributeController::class,'create_variant_name'])->name('create.product_variant_name');
    Route::post('store-variant-name', [AttributeController::class,'store_variant_name'])->name('store.product_variant_name');
    // end variant name
    ...
    Route::get('product-not-recomended/{id}', [ProductController::class, 'not_recomended'])->name('not-recomended');
Route::get('product-make-recomended/{id}', [ProductController::class, 'make_recomended'])->name('make-recomended');
...
Route::group(['as' => 'front.'], function(){
    Route::controller(FrontHomeController::class)->group(function(){
        ...
        Route::get('/offers/product', 'offers_product')->name('offer_product');
    });
    ...
    Route::controller(FrontProductController::class)->group(function(){
        Route::group(['as'=> 'product.'], function(){
            ...
            Route::get('get-variation_sim', 'get_variation_sim')->name('get-variation_sim');
            Route::get('get-variation_region', 'get_variation_region')->name('get-variation_region');
            Route::get('get-variation_color', 'get_color_price')->name('get-variation_color');
            Route::get('/shop/single-product/{slug}/{id}', 'shop_single')->name('shop-single');
            ...
            Route::get('compare-product','compare_product')->name('compare-product');
        });
    });
    ...
    Route::controller(FrontCartController::class)->group(function(){
        ...
        /* Add To Compare */
        Route::get('add-compare/{product_id}','add_compare')->name('add-compare');
    });
