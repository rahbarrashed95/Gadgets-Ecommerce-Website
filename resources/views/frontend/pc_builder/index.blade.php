...
<div class="main-wrapper container-fluid">
    <br /> 
    <div class="bg-gradient container-fluid" style="background: #F17E23 !important;">
    <div class="col-12 product-header">
        <div class="section_title text-light">
           <a href="" style="color: #ffffff;"> <h4 class="semi p-1 m-0 prodCatcus" style="text-align:center">Build Your PC </h4> </a>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                <div class="cart-items">
                    ...
                    <table class="table table-condensed table-bordered">
                        <thead style="background:#F17E23; color: white; text-align:center">
                            <tr>
                                <td>Icon</td>
                                <td>Category Name</td>
                                <td>Action</td>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <button data-id="{{ $pcb->category->id }}"
                                        class="btn btn-success choose-category" style="background: #F17E23;">
                                        Choose
                                    </button>
                                    @endif
                                    @if(!empty($pcb->category->id))
                                    @if (in_array($pcb->category->id, $categoryIdsInCart))
                                    <p class="is_selected_{{ $pcb->category->id }}" style="background: #F17E23; color: white; width: 30%; border-radius: 9px; padding: 5px; margin: 5px;">added</p>
                                    @endif
                                    @endif
                                </td>
                            </tr>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <table class="table table-bordered">
                    <thead style="background:#F17E23; color: white;">
                        <tr>
                            <th>Name</th>
                            <th>image</th>
                            <th>Price</th>
                ...
                @if(!empty($carts))
                        ...
                        </a><a style="color: #F17E23;" href="{{ route('front.checkout.index') }}"
                            class="text-cap btn text-light">Proceed to Checkout <span><i
