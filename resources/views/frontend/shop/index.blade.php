...
@section('content')
 <div class="main-wrapper">
        ...
        <div class="category-page mcontainer p-0 m-auto mt-2 mb-2">
            <!--<div class="cat_tags my-4">-->
            <!--   @foreach($brands as $brand)-->
            <!--    <a href="" class="btn btn-outline-danger rounded-5 m-2">d</a>-->
            <!--   @endforeach-->
            <!--</div>-->
            <div class="row">
                <!-- filter section  -->
            ...
            <!--                        <input id="min-price" name="min_price" value="{{ $minPrice }}" min="{{ $minPrice }}" max="{{ $maxPrice }}" step="2" type="number">    -->
                                    
            <!--                        <input id="max-price" name="max_price" value="{{ $maxPrice }}" min="{{ $minPrice }}" max="{{ $maxPrice }}" step="2" type="number">-->
                                    
                                    
            <!--                    </div>-->
            <!--                    <div class="text-end mt-3">-->
            <!--                        <button class="btn primary-bg btn-sm text-end btn-outline-danger text-light">Filter</button>-->
            <!--                    </div>-->
            <!--                    </form>-->
            <!--                </div>-->
            ...
            <!--                <div class="accordion-body p-3">-->
            <!--                    <div class="px-3 py-2">-->
            <!--                        <input type="text" class="form-control shadow-none" placeholder="Search" style="height: 30px;">-->
            <!--                    </div>-->
            <!--                    <div class="form-check py-2">-->
            <!--                        <label class="form-check-label">-->
            <!--                          <input class="form-check-input shadow-none" type="checkbox" value="">-->
