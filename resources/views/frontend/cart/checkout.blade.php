      ...
      <tbody>
        <tr>
          ...
          <div class="d-flex justify-content-between align-item-conter al_btn">
                              <p class="login_text" style="font-size: 14px;">{{ BanglaText('login_account') }}  <a style="font-size: 11px;background: #F17E23" class="btn" href="{{url('login-user')}}" class="text-muted text-decoration-none icon-signin">Login</a></p>
                            
               </div>
               </td>
          <td>
               <div id="coupon-toggle" style="font-size: 12px;background: #F17E23;color: #ffffff;" class="btn">{{BanglaText('coupon_apply') }}</div>
              ...
              <form action="{{ route('front.cart.apply-coupon') }}" method="post" id="coupon_form">
                  ...
                  <div class="">
                      <button type="submit" class="btn text-light" style="font-family: 'Kalpurush', sans-serif;background: #F17E23 !important;">Apply Coupon<i class="fas fa-arrow-right"></i></button>
                  </div>
              </form>
          </div>
          </td>
  ...
  <div class="card-body">  
                        ...
                        <input type="hidden" name="total_amount" id="total_amount" value="{{ number_format($sub_total, 2) }}">
                            ...
                            <!--</div>-->
                              ...
                              <!--</div>-->
                              <button type="submit" class="btn bg-blue text-light" style="font-family: 'Kalpurush', sans-serif;width: 100%;height: 50px;font-size: 20px;background: #F17E23 !important;">{{ BanglaText('confirm_order') }} <i class="fas fa-arrow-right"></i></button>
